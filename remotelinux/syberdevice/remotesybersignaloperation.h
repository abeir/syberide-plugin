...
#ifndef REMOTESYBERSIGNALOPERATION_H
#define REMOTESYBERSIGNALOPERATION_H
...
class REMOTELINUX_EXPORT RemoteSyberSignalOperation
        : public ProjectExplorer::DeviceProcessSignalOperation
{
    Q_OBJECT
public:
    virtual ~RemoteSyberSignalOperation();
...
protected:
    RemoteSyberSignalOperation(const QSsh::SshConnectionParameters &sshParameters);
...
private:
    ...
    friend class SyberDevice;
};
}

#endif // REMOTESYBERSIGNALOPERATION_H
